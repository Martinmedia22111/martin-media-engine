...
const BrandsScene = () => (
  <svg {...baseProps}>
    ...
    <rect x="38" y="86" width="44" height="6" rx="2" fill={GRAPHITE} />
    <rect x="44" y="80" width="32" height="6" rx="2" fill={GRAPHITE_MID} />
    ...
    <path
      ...
      fill={GRAPHITE}
    />
    {/* shield inner emblem — red M monogram bar */}
    <path
    ...
    <circle cx="22" cy="34" r="3" fill={RED} />
    <circle cx="98" cy="34" r="3" fill={RED} />
...
const AiScene = () => (
  <svg {...baseProps}>
    ...
    {/* outer orbit */}
    <circle cx="60" cy="60" r="40" fill="none" stroke={GRAPHITE_SOFT} strokeWidth="1.5" strokeDasharray="3 4" />

    {/* brain hemisphere — left half graphite, right half hollow with grid */}
    <path
    ...
    {/* neural circuit on right hemisphere */}
    <g stroke={RED} strokeWidth="1.8" strokeLinecap="round" fill="none">
    ...
    {/* synapse highlights on left (graphite) hemisphere */}
    ...
    {/* orbiting data nodes — automation/data/email */}
    <circle cx="20" cy="60" r="5" fill={RED} />
    <circle cx="100" cy="60" r="5" fill={GRAPHITE} />
...
const CmoScene = () => (
  <svg {...baseProps}>
    ...
    {/* chessboard plate */}
    <rect x="22" y="80" width="76" height="14" rx="2" fill={GRAPHITE} />
    {/* board squares pattern */}
    <g fill="hsl(var(--background))" opacity="0.85">
    ...
    {/* KING — graphite, central */}
    {/* base */}
    <path d="M44 80 L44 76 L72 76 L72 80 Z" fill={GRAPHITE} />
    {/* body */}
    <path
    ...
    />
    {/* crown cross */}
    <rect x="56" y="32" width="6" height="14" rx="1.5" fill={GRAPHITE} />
    <rect x="51" y="36" width="16" height="5" rx="1.5" fill={GRAPHITE} />
    {/* red crown jewel */}
    <circle cx="59" cy="28" r="3.5" fill={RED} />

    {/* PAWN — small red ally beside king */}
    <path d="M82 80 L82 78 L94 78 L94 80 Z" fill={RED} />
    <path
      d="M84 78 L84 70 C84 66, 86 64, 88 64 L88 64 C88 60, 90 58, 88 58 C86 58, 88 60, 88 64 C90 64, 92 66, 92 70 L92 78 Z"
      fill={RED}
    />
    <circle cx="88" cy="58" r="4" fill={RED} />
