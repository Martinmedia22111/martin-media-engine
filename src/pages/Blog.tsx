...
const articles = [
  { slug: "skolko-stoit-reklamnyj-rolik", title: "Сколько стоит рекламный ролик в 2025 году: разбор цен и форматов", category: "Гайды", date: "15 марта 2026", readTime: "8 мин", excerpt: "Разбираем, из чего складывается стоимость рекламного ролика, какие форматы существуют и как выбрать подход под ваш бюджет и задачу." },
  ...
  { slug: "ai-assistenty-dlya-biznesa", title: "AI-ассистенты для бизнеса: что это, как работает, сколько стоит", category: "Гайды", date: "28 февраля 2026", readTime: "10 мин", excerpt: "Полный гайд по AI-ассистентам: чем отличаются от чат-ботов, какие задачи решают, сколько стоит внедрение и какие результаты ожидать." },
