...
const About = () => (
  <>
    <SEO
      title="О компании"
      description="Martin Media — рекламное агентство полного цикла из Минска. С 2015 года, команда 14 профессионалов, 3000+ реализованных проектов, 125+ довольных клиентов."
      path="/o-kompanii"
    />
    <LocalBusinessJsonLd />
        ...
        <div className="container max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="mt-6 text-lg text-muted-foreground leading-relaxed max-w-2xl">
              Martin Media — рекламное агентство полного цикла из Минска.
              С 2015 года мы помогаем брендам расти: разрабатываем стратегии и креатив,
              производим видео и контент, ведём SMM и performance-маркетинг,
              внедряем AI-решения.
            </p>
            <p className="mt-4 text-muted-foreground leading-relaxed max-w-2xl">
              Закрываем все задачи коммуникации в одном месте — от позиционирования
              и креативной идеи до съёмки рекламных роликов, ведения соцсетей,
              таргетированной рекламы и AI-инструментов для маркетинга. Команда
              из 14 профессионалов создаёт работающие решения, которые приносят
